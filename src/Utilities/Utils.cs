...
{
	// Sizes represent the fixed header size in bytes for each message type.
	Confirm = 3, // MessageType (1) + Ref_MessageID (2)
	Reply = 6, // MessageType (1) + MessageID (2) + Result (1) + Ref_MessageID (2)
	Auth = 3, // MessageType (1) + MessageID (2)
	Join = 3, // MessageType (1) + MessageID (2)
	Msg = 3, // MessageType (1) + MessageID (2)
	Err = 3, // MessageType (1) + MessageID (2)
	Bye = 3, // MessageType (1) + MessageID (2)
